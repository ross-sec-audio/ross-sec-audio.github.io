...
[Good Things Foundation’s 2024 national dataset review](https://www.goodthingsfoundation.org/policy-and-research/research-and-evidence/research-2024/digital-inclusion-datasets) shows:
...
[Women in Identity research](https://www.womeninidentity.org/articles/the-billions-at-stake-digital-id-done-right) shows 12% of UK residents are excluded from identity‑centric systems, including people without fixed addresses, without smartphones, or without stable documentation. Exclusion prevents accessing banking, housing, and essential services.
...
The paper concludes and stresses that:
1) Forcing minors to reveal more personal information online increases their long‑term risk, violating the very principle of child safeguarding.
2) Age‑authentication changes the structure of the internet from an open information network to a permissioned, identity‑gated system.

Age‑authentication laws that try to “segregate minors and suppress content” are a paradox:
They seek to protect children, but harm them, and damage the broader internet and society.
